...
function startStop() {
    if (status === "stopped") {
        ...
        document.getElementById("startBtn").innerHTML = "Berhenti";
        status = "started";
    } else {
...
function reset() {
    ...
    document.getElementById("startBtn").innerHTML = "Mulai";
    display1.innerHTML = "0 : 0 : 0 : 0";
    display2.innerHTML = "0 : 0 : 0 : 0";
    display3.innerHTML = "0 : 0 : 0 : 0";
    display4.innerHTML = "0 : 0 : 0 : 0";
    display5.innerHTML = "0 : 0 : 0 : 0";
    display6.innerHTML = "0 : 0 : 0 : 0";
    display7.innerHTML = "0 : 0 : 0 : 0";
    display8.innerHTML = "0 : 0 : 0 : 0";
